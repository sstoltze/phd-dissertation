...
\fixme{Enten en bemærkning om at $\Omega$ og $X$ begge er CW og dermed
  svag h.æ. => h.æ., eller skriv svag i ``hovedsætningen''. Er $X$ CW?
  Kan vi vise det let?}
...
\label{sec:coef}
\fixme{Andre koefficienter, kan nok gøres ret kort her. Skal ca. bare
  bemærke at alting virker}
...
\begin{theorem}
  ...
  is an isomorphism. \fixme{Snak om stabilisering forfra vs. bagfra, L
  vs. s}
\end{theorem}
...
as discussed in \fixme{Diskuter dette...Hvor?}, the map $L_n$
...
that it is injective. \fixme{Tegn og indsæt her}
...
map. \fixme{Sørg for at vi ved det, eller skriv det her. Henvis til
  May}
...
\[ H^k(X_{3,n+1}(\sigma)) = \ker d_1. \] \fixme{Tegning/diagram. Plus
  argument for at alting under forsvinder. Kræver nok lidt analyse af
  $n$ og $k$}
